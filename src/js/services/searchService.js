app.factory('searchService', ['$q', '$timeout', '$http', function($q, $timeout, $http) {
    ...
    var articles = [{
        articleId: 1,
        images: {
            rect : 'src/images/rect/1.jpg',
            sq : 'src/images/sq/1.jpg'
        },
        ...
        articleId: 2,
        images: {
            rect : 'src/images/rect/2.jpg',
            sq : 'src/images/sq/2.jpg'
        },
        heading: "Sententiae quaerendum contentiones et mea. Alii deserunt voluptatum",
        contentPreview: "Lorem ipsum dolor sit amet, cu nisl regione mel, et nam sonet persecuti. Ius tollit."
    }, {
        articleId: 3,
        images: {
            rect : 'src/images/rect/3.jpg',
            sq : 'src/images/sq/3.jpg'
        },
        ...
        articleId: 4,
        images: {
            rect : 'src/images/rect/4.jpg',
            sq : 'src/images/sq/4.jpg'
        },
        ...
        articleId: 5,
        images: {
            rect : 'src/images/rect/5.jpg',
            sq : 'src/images/sq/5.jpg'
        },
        ...
        articleId: 6,
        images: {
            rect : 'src/images/rect/6.jpg',
            sq : 'src/images/sq/6.jpg'
        },
